...
Most Americans concentrate a meaningful portion of their investable assets into their primary home — with no way to diversify or hedge that exposure.

## Why existing alternatives don't work

There are three products that theoretically provide housing investment exposure today:
...
<Card title="Learn how SQFT tokens work" icon="chart-line" href="/guides/what-is-sqft">
